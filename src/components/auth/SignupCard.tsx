...
export default function SignupCard({ onBackToLogin }: Props) {
  ...
  return (
    <div
      className="relative z-10 w-full max-w-[460px] rounded-3xl border border-white/45 p-8 sm:min-h-[760px] sm:p-10"
      style={{
        background:
    ...
    >
      ...
      <form className="mt-6 space-y-4 sm:max-h-[460px] sm:overflow-y-auto sm:pr-1" onSubmit={handleSubmit}>
        {/* Common Field: Name */}
        <div>
